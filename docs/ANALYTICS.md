...
Для совместимости с Microsoft Excel табличные листы используют обычные диапазоны и worksheet
auto-filter, а не Excel Table XML. Это сохраняет фильтрацию и устраняет recovery warning некоторых
версий Excel.
